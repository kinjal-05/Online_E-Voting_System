...
const UpdateEvent = () => {
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      try {
        const response = await axios.get(`https://voteguard-backend.onrender.com/api/events/events/${eventId}`);
        setEvent({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`https://voteguard-backend.onrender.com/api/events/events/${eventId}`, event);
